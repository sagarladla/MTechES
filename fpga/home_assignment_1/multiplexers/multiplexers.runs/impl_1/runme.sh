...
HD_PWD='C:/Users/maina/fpga/multiplexers/multiplexers.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_4_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_4_1.tcl -notrace
