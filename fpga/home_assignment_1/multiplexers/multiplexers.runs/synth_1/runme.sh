...
HD_PWD='C:/Users/maina/fpga/multiplexers/multiplexers.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_4_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_4_1.tcl
